...
SLOT="0"
LICENSE="MIT"
IUSE="bpd chroma convert doc discogs echonest fetchart flac gstreamer lastgenre
...
src_prepare() {
	...
	for flag in bpd chroma convert discogs echonest fetchart lastgenre mpdstats replaygain web; do
		if ! use ${flag}; then
